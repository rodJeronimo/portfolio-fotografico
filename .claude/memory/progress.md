...
## Próximo
- **Revisão heurística de `@ux-designer`** pendente para M4 (não feita — sessão solo).
- **TASK-0011 (M7 — observabilidade/polish)**: Analytics, error/loading/empty states. Sem bloqueio externo.

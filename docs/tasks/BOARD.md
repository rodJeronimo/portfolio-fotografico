...
**Roadmap original (Fase 0–2 + M0–M8) 100% concluído** (2026-08-23). **Release v1.2.0 em produção** (2026-08-23) — https://github.com/rodJeronimo/portfolio-fotografico/releases/tag/v1.2.0 (redesign fine-art do site público + destaque configurável da Home, ADR-0007). Ver `.claude/memory/progress.md` para o resumo executivo.

...
| [TASK-0006](backlog/TASK-0006-m2-admin-upload-mvp.md) | Admin upload MVP | M2 | `@backend` | Em revisao (PR pendente) |
...
| [TASK-0008](backlog/TASK-0008-m4-galeria-publica.md) | Galeria pública (Home, projetos, lightbox) | M4 | `@frontend` | Em revisao (PR pendente) |
